...
//save users details
$query = "INSERT into `faculty` (username,password,designation,fullname,email,status,photo)
                ...
                <div class="card-body">
				  ...
				  <div class="form-group">
                    ...
                    <select name="cmddesignation" id="select" class="form-control" required="">
                       ...
                       <option value="Super Admin">Faculty</option>
                       <option value="Librarian">Librarian</option>
                       <option value="workshop">Workshop</option>
                       <option value="scholarship">Scholarship</option>
                       <option value="class-teacher">Class Incharge</option>
                       <option value="Sport Director">Sports</option>
