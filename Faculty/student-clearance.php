...
$sql = "SELECT * FROM faculty WHERE in_workshop='" .$in_workshop . "' and in_sport = '". $in_sport."' and in_library = '". $in_library."' and in_scholarship ='" .$in_scholarship. "' and in_class_incharge".$in_class_incharge;
...
<head>
    ...
    function clear_student(matric_no) {
        if (confirm("ARE YOU SURE YOU WISH TO CLEAR STUDENT WITH MATRIC NO. " + " " + matric_no + " " +
                " FOR NYSC/GRADUATION ?")) {
            return true;
        } else {
            return false;
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <table width="1204" height="227" border="0" align="center">
                            <tr>
                                <td width="1090" height="184">
                                    <div class="card">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <table width="85%" align="center" class="table table-bordered table-striped"
                                                id="example1">
                                                <thead>
                                                    <th width="10%">
                                                    ...
                                                    <th width="5%">
                                                        <div align="center">PRN No</div>
                                                    </th>
                                                    <th width="5%">
                                                        <div align="center">Workshop</div>
                                                    </th>
                                                    <th width="6%">
                                                        <div align="center">Sports</div>
                                                    </th>
                                                    <th width="6%">
                                                        <div align="center">Library</div>
                                                    </th>
                                                    <th width="5%">
                                                        <div align="center">Scholarship</div>
                                                    </th>
                                                    <th width="5%">
                                                        <div align="center">Class Incharge / HOD</div>
                                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <div align="center"><span class="controls"><img
                                                    src="../<?php echo $row['photo'];?>" width="91" height="73"
                                                    border="2" /></span></div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if (($row['is_workshop_approved'])==(('1')))  { ?>
                                        <div align="center"><span class="badge badge-success">Cleared</span></div>
                                        <?php } else {?>
                                        <div align="center"><a href="clear_workshop.php?id=<?php echo $row['ID'];?>"
  ...
  <input type="submit" value="Submit">
                                    ...
                                    <td>
                                        ...
                                        <div align="center"><span class="badge badge-success">Cleared</span></div>
                                        <?php } else {?>
                                        <div align="center"><a href="clear_library.php?id=<?php echo $row['ID'];?>"
                                                onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i
                                                    class="fa fa-check" title="Click to Clear Student"> <span
                                                        class="badge badge-warning">Pending</span></i> </a>
                                                        <form action="/action_page.php">
  ...
  <input type="submit" value="Submit">
                                    ...
                                    <td>
                                        <?php if (($row['is_scholarship_approved'])==(('1')))  { ?>
                                        <div align="center"><span class="badge badge-success">Cleared</span></div>
                                        <?php } else {?>
                                        <div align="center"><a href="clear_scholarship.php?id=<?php echo $row['ID'];?>"
                                                onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i
                                                    class="fa fa-check" title="Click to Clear Student"> <span
                                                        class="badge badge-warning">Pending</span></i> </a>
                                                        <form action="/action_page.php">
  ...
  <input type="submit" value="Submit">
                                    ...
                                    <td>
                                        <?php if (($row['is_class_incharge'])==(('1')))  { ?>
                                        <div align="center"><span class="badge badge-success">Cleared</span></div>
                                        <?php } else {?>
                                        <div align="center"><a
                                                href="clear_class_incharge.php?id=<?php echo $row['ID'];?>"
                                                onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i
                                                    class="fa fa-check" title="Click to Clear Student"> <span
                                                        class="badge badge-warning">Pending</span></i> </a>
                                                        <form action="/action_page.php">
