...
<head>
    ...
    <title>Faculty Record | Dashboard</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Faculty Record</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <td width="1043" height="214">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Faculty Record </h4>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <table width="106%" align="center"
                                                class="table table-bordered table-striped" id="example1">
                                                <thead>
                                                    <tr>
                                                        <th width="3%">
                                                ...
                                                <tbody>
                                                    <?php 
                                          $sql = "SELECT * FROM faculty order by username ASC";
                                           $result = $conn->query($sql); 
										$cnt=1;
                                           while($row = $result->fetch_assoc()) { ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                            <div align="center"><?php echo $row['username']; ?></div>
                                                        </td>
                                                        <td>
                                                            <div align="center"><span class="controls"><img
                                                                        src="../<?php echo $row['photo'];?>" width="50"
                                                                        height="43" border="2" /></span></div>
                                                        </td>
                                                        <td>
                                                            <div align="center"><?php echo $row['password']; ?></div>
                                                        </td>
                                                        <td>
                                                            <div align="center"><?php echo $row['designation']; ?></div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div align="center"><?php echo $row['status']; ?></div>
                                                        </td>
                                                        <td>
                                                            <!-- <div class="btn-group"> -->
                                                                <button type="button"
                                                                    class="btn btn-danger btn-flat">Action</button>
                                                                <button type="button"
                                                                ...
                                                                <div class="dropdown-menu" role="menu">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                         href="block-unblock-admin.php?id=<?php echo $row['ID'];?>"
                                                                        onClick="return Deactivate('<?php echo $row['fullname']; ?> ');">Deactivate</a> 
                                                                    <?php } else {?>
                                                                    <a class="dropdown-item"
                                                                        href="block-unblock-admin.php?uid=<?php echo $row['ID'];?>"
                                                                        onClick="return Activate('<?php echo $row['fullname']; ?> ');">Activate</a>
                                                                    <?php } ?>
                                                                    <a class="dropdown-item"
                                                                        href="edit-admin.php?id=<?php echo $row['ID'];?>">Edit</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
